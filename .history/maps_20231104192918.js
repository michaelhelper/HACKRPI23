...
// ----------------------------------------------------------------------------
    ...
    alert(`The 5 closest hospitals are: ${closestHospitals[0].name}, ${closestHospitals[1].name}, ${closestHospitals[2].name}, ${closestHospitals[3].name}, ${closestHospitals[4].name}.`);
    };
