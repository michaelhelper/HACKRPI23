            ...
            closestHospitals.forEach(facility => {
                ...
                directionsService.route(request, function(result, status) {
                    if (status == 'OK') {
                        ...
                        let drivingTime1 = result.routes[0].legs[0].duration.text;
                        console.log(`It will take ${drivingTime1} to drive from ${userLocation} to ${hospitalName}.`);
                        // add the driving time to the hospital object
                        closestHospitals[counter].drivingTime = drivingTime1;
